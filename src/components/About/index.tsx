          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="" style={{ textAlign: "justify", fontWeight: '400' }}>
                ...
                the grass-root level, in the fields of Agriculture, microentrepreneurship, sanitation, and health and education.
                ...
                <Link to='/about' target='_blank' className="read-btn btn btn-primary mt-3">Read More</Link>
              </p>
            </div>
            {!isMobile && (
