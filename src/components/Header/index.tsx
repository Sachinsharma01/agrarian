        ...
        <div className="container-fluid">
          <div className="container-fluid">
            <div className="row">
                  ...
                  <div className="container-fluid text-center h-100">
                    <ul className="row h-100">
                      ...
                      <li key={3} className="col-2">
                        ...
                        >
                          <span className="link">
                            <span className={active === "team" ? "active" : ""}>
                              Team
                            </span>
                          </span>
                        </Link>
              ...
              {isSiderBarOpen && <SideBar setOpen={setOpen} />}
            </div>
          </div>
        </div>
      </nav>
